...
import integratedtoolkit.loader.total.StreamRegistry;
...
public class LoaderConstants {
    ...
    // Packages
    public static final String PACKAGE_COMPSS_ROOT = "integratedtoolkit";
    ...
    // Custom loader names
    public static final String CUSTOM_LOADER_PREFIX = "integratedtoolkit.loader.";
    public static final String CUSTOM_LOADER_SUFFIX = ".ITAppModifier";

    // Total loader names
    public static final String LOADER_INTERNAL_PREFIX = "integratedtoolkit.";
