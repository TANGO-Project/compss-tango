...
public class ResourcesFile {
     ...
     * @throws InvalidElementException
     */
    public DataNodeType addDataNode(String name, String host, String path, List<AdaptorType> adaptors, StorageType storage,
            AttachedDisksListType sharedDisks) throws InvalidElementException {
     ...
     * @throws InvalidElementException
     */
    public DataNodeType addDataNode(String name, String host, String path, AdaptorsListType adaptors, StorageType storage,
            List<AttachedDiskType> sharedDisks) throws InvalidElementException {
    ...
    public DataNodeType addDataNode(String name, String host, String path, AdaptorsListType adaptors, StorageType storage,
        ...
        JAXBElement<AdaptorsListType> adaptorsElement = new JAXBElement<AdaptorsListType>(new QName("Adaptors"), AdaptorsListType.class,
                adaptors);
        ...
        if (sharedDisks != null) {
            JAXBElement<AttachedDisksListType> sdsElement = new JAXBElement<AttachedDisksListType>(new QName("SharedDisks"),
                    AttachedDisksListType.class, sharedDisks);
    ...
    public ComputeNodeType addComputeNode(String name, List<ProcessorType> processors, AdaptorsListType adaptors)
            throws InvalidElementException {
        return this.addComputeNode(name, processors, adaptors, null, null, null, (SoftwareListType) null, (AttachedDisksListType) null,
                null);
    }
    ...
    public ComputeNodeType addComputeNode(String name, List<ProcessorType> processors, List<AdaptorType> adaptors)
        ...
        return this.addComputeNode(name, processors, adaptorsList, null, null, null, (SoftwareListType) null, (AttachedDisksListType) null,
                null);
    }
     ...
     * @throws InvalidElementException
     */
    public ComputeNodeType addComputeNode(String name, List<ProcessorType> processors, AdaptorsListType adaptors, MemoryType memory,
            StorageType storage, OSType os, List<String> applications, AttachedDisksListType sharedDisks, PriceType price)
            throws InvalidElementException {
     ...
     */
    public ComputeNodeType addComputeNode(String name, List<ProcessorType> processors, AdaptorsListType adaptors, MemoryType memory,
            StorageType storage, OSType os, SoftwareListType software, List<AttachedDiskType> sharedDisks, PriceType price)
            throws InvalidElementException {
     ...
     * @throws InvalidElementException
     */
    public ComputeNodeType addComputeNode(String name, List<ProcessorType> processors, List<AdaptorType> adaptors, MemoryType memory,
            StorageType storage, OSType os, List<String> applications, List<AttachedDiskType> sharedDisks, PriceType price)
            throws InvalidElementException {
     ...
     */
    public ComputeNodeType addComputeNode(String name, List<ProcessorType> processors, AdaptorsListType adaptors, MemoryType memory,
            StorageType storage, OSType os, SoftwareListType software, AttachedDisksListType sharedDisks, PriceType price)
            throws InvalidElementException {
     ...
     * @throws InvalidElementException
     */
    public ComputeNodeType addComputeNode(String name, List<ProcessorType> processors, List<AdaptorType> adaptors, float memorySize,
            float diskSize, String osName) throws InvalidElementException {
     ...
     * @throws InvalidElementException
     */
    public CloudProviderType addCloudProvider(String name, EndpointType endpoint, ImagesType images, InstanceTypesType instances)
            throws InvalidElementException {
     ...
     * @throws InvalidElementException
     */
    public CloudProviderType addCloudProvider(String name, EndpointType endpoint, List<ImageType> images, List<InstanceTypeType> instances)
            throws InvalidElementException {
     ...
     * @throws InvalidElementException
     */
    public CloudProviderType addCloudProvider(String name, EndpointType endpoint, ImagesType images, List<InstanceTypeType> instances)
            throws InvalidElementException {
     ...
     * @throws InvalidElementException
     */
    public CloudProviderType addCloudProvider(String name, EndpointType endpoint, List<ImageType> images, InstanceTypesType instances)
            throws InvalidElementException {
